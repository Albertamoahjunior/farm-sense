...
\begin{figure}[h]
\includegraphics[scale=0.5]{{/cropscope-login.jpg}}
...
\begin{figure}[h]
\includegraphics[scale=0.5]{{/cropscope-graph.jpg}}
...
\begin{figure}[h]
\includegraphics[scale=0.5]{{/cropscope-recommend.jpg}}
...
\begin{figure}[h]
\includegraphics[scale=0.5]{{/cropscope-weather.jpg}}
\caption{Admin Routes Code}
