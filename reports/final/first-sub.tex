...
\end{figure}
In the above image is a diagram of the system architecture of the farm monitoring system. The system is comprised of five (5) major parts: the Sensor node, the power supply unit, the cloud service being used, and the client interface. All these separate parts come together to monitor, transmit, and analyze the vital farm conditions in scope.\\
