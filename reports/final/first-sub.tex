...
We will build a wireless sensor network to monitor the factors of concern in the farm.
\item \textbf{Establish a cloud service for analysis}\\
We will set up a cloud service to analyse data collected from the farm
